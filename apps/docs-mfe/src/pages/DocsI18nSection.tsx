    ...
    <div className="space-y-8">
      <div className="space-y-2">
        ...
        <p className="text-lg text-neutral-500 dark:text-neutral-400">
          Panduan penggunaan multi-bahasa (Indonesia, English, Arabic) di aplikasi Nashta Hajj.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Platform Micro-Frontend Nashta Hajj telah dilengkapi dengan konfigurasi{' '}
            ...
            yang terpusat pada library <strong>@nashta/shared-types</strong>. Anda tidak perlu
    ...
    <div>
      ...
      <button>{t('submit_button', 'Simpan')}</button>
          ...
          >
            ...
            <CodeBlock
              language="tsx"
              codeString={`import { i18n } from '@nashta/shared-types';
