        ...
        <div className="border-2 border-dashed border-amber-300 dark:border-amber-700 rounded-xl p-8 text-center">
          ...
          <div className="bg-neutral-50 dark:bg-neutral-900 rounded-lg p-4 text-left max-w-lg mx-auto">
            ...
            <ol className="space-y-2 text-sm text-neutral-600 dark:text-neutral-400">
              <li>
                <span className="font-medium text-neutral-900 dark:text-neutral-100">1.</span> Buat file <code className="text-xs bg-neutral-100 dark:bg-neutral-800 px-1 rounded">apps/shell/src/pages/ui-kit/{name}Section.tsx</code>
              </li>
              <li>
              ...
              <li>
                <span className="font-medium text-neutral-900 dark:text-neutral-100">3.</span> Import dan tambahkan ke <code className="text-xs bg-neutral-100 dark:bg-neutral-800 px-1 rounded">SECTION_MAP</code> di UIKit.tsx:
              </li>
            </ol>
            <CodeBlock>{`// Di UIKit.tsx SECTION_MAP, tambahkan:
import { ${name}Section } from './ui-kit/${name}Section';
