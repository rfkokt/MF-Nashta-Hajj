...
Selamat datang di platform *Micro-Frontend* (MFE) Nashta Hajj. Proyek ini menggunakan arsitektur monorepo dengan **Nx**, **Vite**, dan **Webpack Module Federation** (_melalui `@module-federation/vite`_).
